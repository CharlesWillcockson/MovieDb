...
$.get("https://api.themoviedb.org/3/search/movie?api_key=36bae576330e105013948f7fc0b734c0&language=en-US&query=tenet&page=1&include_adult=false").done(function (data){
    console.log(data)
